...
const unsigned imx8m_edma0_requests[IMX_DMA0_CH_NUM] = {
...
const unsigned imx8m_edma1_requests[IMX_DMA1_CH_NUM] = {
...
const unsigned imx8m_edma2_requests[IMX_DMA2_CH_NUM] = {
...
const unsigned imx8m_edma3_requests[IMX_DMA3_CH_NUM] = {
...
const unsigned imx8xp_edma0_requests[IMX_DMA0_CH_NUM] = {
    IMX_DMA_REQ_LPSPI0_RX           ,
    IMX_DMA_REQ_LPSPI0_TX           ,
    IMX_DMA_REQ_LPSPI1_RX           ,
    IMX_DMA_REQ_LPSPI1_TX           ,
...
const unsigned imx8xp_edma1_requests[IMX8XP_DMA1_CH_NUM] = {
    IMX_DMA_REQ_LPI2C0_RX       ,
    IMX_DMA_REQ_LPI2C0_TX       ,
    IMX_DMA_REQ_LPI2C1_RX       ,
    IMX_DMA_REQ_LPI2C1_TX       ,
...
const unsigned imx8xp_edma2_requests[IMX_DMA2_CH_NUM] = {
    IMX_DMA_REQ_ASRC0_PAIR_A_INPUT  ,
    IMX_DMA_REQ_ASRC0_PAIR_B_INPUT  ,
    IMX_DMA_REQ_ASRC0_PAIR_C_INPUT  ,
    IMX_DMA_REQ_ASRC0_PAIR_A_OUTPUT ,
...
const unsigned imx8xp_edma3_requests[IMX8XP_DMA3_CH_NUM] = {
    IMX_DMA_REQ_ASRC1_PAIR_A_INPUT  ,
    IMX_DMA_REQ_ASRC1_PAIR_B_INPUT  ,
    IMX_DMA_REQ_ASRC1_PAIR_C_INPUT  ,
    IMX_DMA_REQ_ASRC1_PAIR_A_OUTPUT ,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/dma/public/aarch64/imx8_common/imx_edma_requests.h $ $Rev: 883566 $")
#endif
