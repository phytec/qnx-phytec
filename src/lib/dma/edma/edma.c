 ...
 */
static const struct sigevent *channel_irq_handler(void *area, __attribute__((unused)) int id)
{
 ...
 * @return Address of event structure or NULL.
 */
static const struct sigevent *error_irq_handler(void *area, __attribute__((unused)) int id)
{
    chn_info_t       *chn_info_ptr = (chn_info_t *)area;
 ...
 */
static void imx_edma_set_bus_attr(chn_info_t *chn_info_ptr, uint32_t src_phy, uint32_t dst_phy,
                           dma_xfer_flags src_flags, dma_xfer_flags dst_flags)
{
 ...
 * @return Always returns 0.
 */
static int imx_edma_channel_info(__attribute__((unused)) unsigned channel, dma_channel_info_t *info)
{
 ...
 */
static int parse_channel_options(chn_info_t * chn_info_ptr, const char *options)
{
    char    *value;
    int     opt;
    char    *temp_ptr = NULL;
...
static void imx_edma_query_channel ( void *handle, dma_channel_query_t *chninfo)
{
 ...
 * @return Execution status.
 */
static int imx_edma_init(__attribute__((unused)) const char *options)
{
    return EOK;
}
 ...
 */
static unsigned imx_edma_bytes_left(void *handle)
{
    chn_info_t  *chn_info_ptr = (chn_info_t *)handle;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/dma/edma/edma.c $ $Rev: 905647 $")
#endif
