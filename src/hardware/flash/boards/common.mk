...
# Check for USEFILE override at VARIANT1 level
ifneq ($(wildcard $(PRODUCT_ROOT)/boards/$(SECTION)/$(CPU)/$(VARIANT1)/devf-$(SECTION)-$(VARIANT1).use),)
USEFILE = $(PRODUCT_ROOT)/boards/$(SECTION)/$(CPU)/$(VARIANT1)/devf-$(SECTION)-$(VARIANT1).use
else
# Check for USEFILE override at SECTION level
ifneq ($(wildcard $(PRODUCT_ROOT)/boards/$(SECTION)/devf-$(SECTION).use),)
USEFILE = $(PRODUCT_ROOT)/boards/$(SECTION)/devf-$(SECTION).use
else
# Otherwise use the mtd-flash USEFILE
