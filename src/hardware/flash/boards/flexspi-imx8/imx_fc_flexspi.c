 ...
 */
const struct sigevent *qspi_intr(void *area, int id)
{
    imx_fspi_t *dev = area;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/boards/flexspi-imx8/imx_fc_flexspi.c $ $Rev: 889622 $")
#endif
