 ...
 */
int32_t f3s_flexspi_read(__attribute__((unused)) f3s_dbase_t *dbase, f3s_access_t *access,
                        __attribute__((unused)) uint32_t flags, uint32_t text_offset,
                        int32_t buffer_size, uint8_t *buffer)
{
    int rc;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/flash/boards/flexspi-imx8/f3s_flexspi_read.c $ $Rev: 893539 $")
#endif
