 ...
 */
int32_t f3s_flexspi_write(__attribute__((unused)) f3s_dbase_t *dbase, f3s_access_t *access, uint32_t flags,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/flash/boards/flexspi-imx8/f3s_flexspi_write.c $ $Rev: 893539 $")
#endif
