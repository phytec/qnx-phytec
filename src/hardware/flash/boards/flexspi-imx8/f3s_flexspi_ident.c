 ...
 */
int f3s_flexspi_ident(f3s_dbase_t *dbase, f3s_access_t *access, uint32_t flags, uint32_t offset)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/boards/flexspi-imx8/f3s_flexspi_ident.c $ $Rev: 885792 $")
#endif
