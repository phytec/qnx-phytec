 ...
 */
uint8_t * f3s_flexspi_page(f3s_socket_t *socket, __attribute__((unused)) uint32_t flags,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/flash/boards/flexspi-imx8/f3s_flexspi_page.c $ $Rev: 893539 $")
#endif
