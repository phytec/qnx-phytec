...
#define IMX_DCMD_SC_MISC_GET_BOOT_DEV                    __DIOTF(_DCMD_MISC, IMX_DCMD_MISC(15), sc_rsrc_t)
...
/** Calls sc_misc_get_boot_type() function */
#define IMX_DCMD_SC_MISC_GET_BOOT_TYPE                   __DIOTF(_DCMD_MISC, IMX_DCMD_MISC(17), sc_misc_bt_t)
/** Calls sc_misc_get_boot_container() function */
#define IMX_DCMD_SC_MISC_GET_BOOT_CONTAINER              __DIOTF(_DCMD_MISC, IMX_DCMD_MISC(18), uint8_t)
/** Calls sc_misc_build_info() function */
...
#define IMX_DCMD_SC_MISC_BOARD_IOCTL                     __DIOF(_DCMD_MISC,  IMX_DCMD_MISC(27), imx_dcmd_sc_misc_board_ioctl_t)
/* ------------------------------------------------- PAD API ----------------------------------------------- */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/support/sc-imx8/public/sys/imx8_sci_mgr.h $ $Rev: 907901 $")
#endif
