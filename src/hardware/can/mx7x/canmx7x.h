...
void can_init_intr(CANDEV_FLEXCAN_INFO *devinfo, CANDEV_FLEXCAN_INIT *devinit, int mdriver_intr);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/can/mx7x/canmx7x.h $ $Rev: 893475 $")
#endif
