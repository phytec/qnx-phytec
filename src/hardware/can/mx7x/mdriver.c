 ...
 */
int mdriver_find_mbxid(CANDEV_FLEXCAN_INFO *devinfo, uint32_t canmid)
{
    int i;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/can/mx7x/mdriver.c $ $Rev: 841380 $")
#endif
