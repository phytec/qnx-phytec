...
#define TFCR_TE(x)   ((1<<(x+2))&TFCR_TEMASK)
#define TFCR_TFR     (1<<1)
#define TFCR_TFE     (1<<0)
    vuint32_t   tfsr;
...
#define TCR_TE(x)   ((1<<x)&TCR_TEMASK)
    vuint32_t   tccr;
...
#define FS_BIT      1
    ...
    vint32_t            playback_frag_index;
    vint32_t            capture_frag_index;
...
#define MAX_NUM_SDI_PINS    4
    ...
    void                *sdo_reconstitute_buffer;
    void                *sdi_reconstitute_buffer;
    uint8_t             async_clks:1;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/deva/ctrl/mxesai/mxesai.h $ $Rev: 903313 $")
#endif
