...
typedef struct cs42xx8_context{
    ...
    uint32_t *chn_mask[SND_PCM_CHANNEL_MAX];
} cs42xx8_context_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/deva/mixer/cs42xx8/cs42xx8.h $ $Rev: 894922 $")
#endif
