...
static int32_t build_wm8960_mixer(MIXER_CONTEXT_T * wm8960, ado_mixer_t * mixer)
{
    ...
    if ((adc_io = ado_mixer_element_io(mixer, "MICIN", SND_MIXER_ETYPE_INPUT, 0, chmap)) == NULL) {
        return (-1);
    }
    ...
    if (ado_mixer_capture_group_create(mixer, SND_MIXER_MIC_IN, chmap, input_vol, input_mute, NULL, NULL) == NULL) {
        return (-1);
    }
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/deva/mixer/wm8960/wm8960.c $ $Rev: 912698 $")
#endif
