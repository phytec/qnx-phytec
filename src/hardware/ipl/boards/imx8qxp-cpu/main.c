...
extern void imx_init_console(sc_ipc_t ipc);
extern void imx_init_clocks(sc_ipc_t ipc);
extern void imx_init_pinmux(sc_ipc_t ipc);
 ...
 */
void imx_get_chip_info(sc_ipc_t ipc, uint32_t *type, uint32_t *rev)
{
...
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/ipl/boards/imx8qxp-cpu/main.c $ $Rev: 904589 $")
#endif
