...
/* Function prototypes */
extern void imx_init_lpuart(uintptr_t port, uint32_t baud, uint32_t clk, uint32_t osr);
...
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/ipl/boards/imx8qxp-cpu/init.c $ $Rev: 869194 $")
#endif
