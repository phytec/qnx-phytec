...
extern void init_8250(unsigned long address, unsigned baud, unsigned clk, unsigned divisor);
int image_download_8250(unsigned baud, unsigned long port_address, unsigned long dst_address);
...
extern unsigned			image_download_ser(unsigned long);
...
extern void				ser_puthex64(unsigned long x);
...
extern void				init_sermx7(unsigned port, unsigned baud, unsigned clk, unsigned divisor);
...
#ifdef __aarch64__
void					init_serscif(unsigned base, unsigned baud, unsigned clk, unsigned extclk);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/ipl/lib/ipl.h $ $Rev: 862290 $")
#endif
