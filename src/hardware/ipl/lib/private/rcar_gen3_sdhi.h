...
#ifndef _RCAR_GEN3_SDHI_INCLUDED
#define _RCAR_GEN3_SDHI_INCLUDED
...
/*-------------------------------------------*/
typedef struct rcar_gen3_sdmmc_bs {
    void (*init)(sdmmc_t *sdmmc);
} rcar_gen3_sdmmc_bs_t;

extern void rcar_gen3_sdmmc_init_hc(sdmmc_t *sdmmc, unsigned base, unsigned clock, int verbose);
extern void rcar_gen3_sdmmc_init_bs(rcar_gen3_sdmmc_bs_t *bs);
extern int rcar_gen3_sdmmc_fini(sdmmc_t *sdmmc);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/ipl/lib/private/rcar_gen3_sdhi.h $ $Rev: 887585 $")
#endif
