...
#ifndef _IMX_SDHC_INCLUDED
#define _IMX_SDHC_INCLUDED
...
#define MMCSYSCTL_IPP_RST_N        (1 << 23)
...
#define MMCINTR_ERRI             (MMCINTR_DMAE | MMCINTR_AC12E | MMCINTR_DEBE | MMCINTR_DCE | MMCINTR_DTOE | MMCINTR_CIE | MMCINTR_CEBE | MMCINTR_CCE | MMCINTR_CTOE)
...
#define MX_MMCMIX_CTRL                  0x48
#define MX_MMCFORCEEVENT                0x50
#define MX_MMCADMAERRST                 0x54
#define MX_MMCADMASYSADD                0x58
#define MX_MMCHCTLRVER                  0xFC

extern void imx_sdmmc_init_hc(sdmmc_t *sdmmc, unsigned base, unsigned clock, int verbose);
extern int imx_sdmmc_fini(sdmmc_t *sdmmc);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/ipl/lib/private/imx8_sdhc.h $ $Rev: 878192 $")
#endif
