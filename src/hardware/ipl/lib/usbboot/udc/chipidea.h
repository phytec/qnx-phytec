...
typedef struct _chip_idea_endpoint {
	void					*urb_mem;
	usb_endpoint_t			*ep;			/* back pointer						*/
...
#ifndef CHIP_IDEA_EXTRA_PRE_INTERRUPT_CALLOUT
    #define CHIP_IDEA_EXTRA_PRE_INTERRUPT_CALLOUT
#endif
...
extern int chip_idea_init( void *hdl );
extern int chip_idea_shutdown( usb_dc_t *udc );
extern int chip_idea_set_bus_state( usb_dc_t *udc, uint32_t device_state );
extern int chip_idea_set_device_address(  usb_dc_t *udc, uint8_t device_address );
extern int chip_idea_select_configuration( usb_dc_t *udc, uint8_t config );
extern int chip_idea_set_endpoint_state( usb_dc_t *udc, usb_endpoint_t *ep, uint32_t ep_state );
extern int chip_idea_clear_endpoint_state( usb_dc_t *udc, usb_endpoint_t *ep, uint32_t ep_state );
extern int chip_idea_interrupt( usb_dc_t *udc, uint32_t *emask);
extern int chip_idea_endpoint_enable( usb_dc_t *udc, usb_endpoint_t *ep );
extern int chip_idea_endpoint_disable( usb_dc_t *udc, usb_endpoint_t *ep );
extern int chip_idea_transfer_abort( usb_dc_t *udc, usb_endpoint_t *ep );
extern int chip_idea_transfer( usb_dc_t *udc, usb_endpoint_t *endp, usb_transfer_t *urb, _uint32 flags );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/ipl/lib/usbboot/udc/chipidea.h $ $Rev: 853882 $")
#endif
