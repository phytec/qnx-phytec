 ...
 */
static const struct sigevent * spi_intr(void *area, __attribute__((unused)) int id)
{
    imx_spi_t *dev = area;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/spi/imx8lpspi/intr.c $ $Rev: 911803 $")
#endif
