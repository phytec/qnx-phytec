 ...
 */
static void spi_reg_dump(uintptr_t base, const char *func, int line) {
 ...
 * @return     EOK always
 */
int imxspi_drvinfo(__attribute__((unused)) void *hdl, spi_drvinfo_t *info)
{
 ...
 */
int imxspi_devinfo(__attribute__((unused)) void *hdl, uint32_t device, spi_devinfo_t *info)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/spi/imx8lpspi/mx8lpspi.c $ $Rev: 893541 $")
#endif
