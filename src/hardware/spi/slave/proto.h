...
int _spi_notify(resmgr_context_t *ctp, io_notify_t *msg, spi_ocb_t *ocb);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/spi/slave/proto.h $ $Rev: 855721 $")
#endif
