...
#define _READ_DATA(msg)			((void *)(sizeof(msg) + (char *)(&msg)))
...
_spi_read(resmgr_context_t *ctp, io_read_t *msg, spi_ocb_t *ocb)
{
	...
	dev->funcs->read(drvhdl, 0, buf, &nbytes);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/spi/slave/_spi_read.c $ $Rev: 888596 $")
#endif
