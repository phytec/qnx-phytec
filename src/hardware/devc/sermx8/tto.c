 ...
 */
void lpuart_setbaudrate(DEV_UART *dev, uint32_t sourceClockInHz, uint32_t desiredBaudRate)
{
    uintptr_t base = dev->base;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devc/sermx8/tto.c $ $Rev: 905321 $")
#endif
