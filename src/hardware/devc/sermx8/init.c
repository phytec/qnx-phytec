 ...
 */
void * query_default_device(__attribute__((unused)) TTYINIT_UART *dip, __attribute__((unused)) void *link)
{
    /*
...
#else
    (void)(smmu_ports_created); /* Not used without DMA */
#endif
    /*
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devc/sermx8/init.c $ $Rev: 893169 $")
#endif
