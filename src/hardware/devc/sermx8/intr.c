 ...
 */
void lpuart_tx_pulse_hdlr(DEV_UART *dev, __attribute__((unused)) struct sigevent *event)
{
    int status = 0;
 ...
 */
void lpuart_rx_pulse_hdlr(DEV_UART *dev, __attribute__((unused)) struct sigevent *event)
{
...
#endif
static inline int ms_interrupt(__attribute__((unused)) DEV_UART *dev)
{
    int status = 0;
#if 0
    uintptr_t       base = dev->base;
...
static inline int do_interrupt(DEV_UART *dev, __attribute__((unused)) int id)
{
    int      sts=0;
...
static int interrupt_event_handler (__attribute__((unused)) message_context_t * msgctp, __attribute__((unused)) int code,
            __attribute__((unused)) unsigned flags, void *handle)
{
    uint32_t status;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devc/sermx8/intr.c $ $Rev: 893169 $")
#endif
