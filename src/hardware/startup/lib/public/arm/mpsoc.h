 ...
 * -------------------------------------------------------------------------
 */
#define XZYNQ_SATA_BASEADDR         0xFD0C0000
#define XZYNQ_SATA_SIZE             0x1F8

/* Ceva Vendor Specific Register Offsets */
#define XZYNQ_AHCI_VEND_PCFG        0xA4
  #define XZYNQ_PCFG_PAD_SHIFT          0
  #define XZYNQ_PCFG_PAD_MASK           (0x1F << XZYNQ_PCFG_PAD_SHIFT)
  #define XZYNQ_PCFG_PAD_PORT0          (0x2 << XZYNQ_PCFG_PAD_SHIFT)
  #define XZYNQ_PCFG_PAD_PORT1          (0x3 << XZYNQ_PCFG_PAD_SHIFT)
#define XZYNQ_AHCI_VEND_PP2C        0xAC
#define XZYNQ_AHCI_VEND_PP3C        0xB0
#define XZYNQ_AHCI_VEND_PP4C        0xB4
#define XZYNQ_AHCI_VEND_PP5C        0xB8
#define XZYNQ_AHCI_VEND_PAXIC       0xC0
  #define XZYNQ_PAXIC_OTL_SHIFT         20
  #define XZYNQ_PAXIC_OTL_MASK          (0xF << XZYNQ_PAXIC_OTL_SHIFT)
  #define XZYNQ_PAXIC_OTL_VAL(x)        ((x << XZYNQ_PAXIC_OTL_SHIFT) & XZYNQ_PAXIC_OTL_MASK)
  #define XZYNQ_PAXIC_ADBW_SHIFT        0
  #define XZYNQ_PAXIC_ADBW_MASK         (0x3 << XZYNQ_PAXIC_ADBW_SHIFT)
  #define XZYNQ_PAXIC_ADBW_BW64         (0x1 << XZYNQ_PAXIC_ADBW_SHIFT)
#define XZYNQ_AHCI_VEND_PTC         0xC8
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/arm/mpsoc.h $ $Rev: 909913 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/public/arm/mpsoc.h $ $Rev: 909913 $" )
#endif
#endif
