...
uintptr_t	gic_lpi_cfg_vaddr;			// callout vaddr for LPI config table (v3 only)
unsigned	gic_gicr_shift;				// shift value for GICR spacing (v3 only)

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/aarch64/gic.c $ $Rev: 890390 $")
#endif
