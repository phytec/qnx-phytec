...
const static struct startup_intrinfo pci_steer_intr[] = {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx8xp/imx_init_intrinfo.c $ $Rev: 869196 $")
#endif
