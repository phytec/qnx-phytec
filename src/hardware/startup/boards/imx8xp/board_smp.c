 ...
 */
void board_smp_init(struct smp_entry *smp, __attribute__((unused)) unsigned num_cpus)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/boards/imx8xp/board_smp.c $ $Rev: 891625 $")
#endif
