 ...
 */
void imx_print_power_up_fail(const char * func_name, sc_rsrc_t resource, sc_err_t sc_status)
{
 ...
 * @param sc_status SC status information to print.
 */
void imx_print_set_clock_fail(const char * func_name, sc_rsrc_t resource, uint32_t freq, sc_err_t sc_status)
{
 ...
 * @param sc_status SC status information to print.
 */
void imx_print_get_clock_fail(const char * func_name, sc_rsrc_t resource, sc_err_t sc_status)
{
 ...
 * @param sc_status SC status information to print.
 */
void imx_print_clock_enable_fail(const char * func_name, sc_rsrc_t resource, sc_err_t sc_status)
{
 ...
 * @param sc_status SC status information to print.
 */
void imx_print_clock_disable_fail(const char * func_name, sc_rsrc_t resource, sc_err_t sc_status)
{
 ...
 */
sc_err_t imx_init_periph_clock(sc_ipc_t ipc, sc_rsrc_t resource, sc_pm_clk_t clk, sc_pm_clock_rate_t * rate,
 ...
 * @param ipc IPC handle.
 */
void imx_sci_error_occurred(sc_ipc_t ipc)
{
    sc_err_t sc_status;
 ...
 * @return Execution status.
 */
int imx_init_usb_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    uint32_t val;
 ...
 * @return Execution status.
 */
int imx_init_enet_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_gpio_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    sc_rsrc_t index;
 ...
 * @return Execution status.
 */
int imx_init_gpt_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_dc_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
 ...
 * @return Execution status.
 */
int imx_init_i2c_clock(imx_startup_data_t * startup_data)
{
    uint32_t i;
    sc_err_t sc_status;
    typedef struct {
 ...
 * @return Execution status.
 */
int imx_init_lpspi_clock(imx_startup_data_t * startup_data)
{
    sc_rsrc_t i;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_flexspi_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    sc_pm_clock_rate_t rate;
    do {
 ...
 * @return Execution status.
 */
int imx_init_usdhc_clock(imx_startup_data_t * startup_data)
{
    sc_err_t            sc_status;
    sc_pm_clock_rate_t  rate;
    uint32_t            i;
 ...
 * @return Execution status.
 */
int imx_init_audio_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    uint32_t i;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_flexcan_clock(imx_startup_data_t * startup_data)
{
    sc_err_t           sc_status;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_lpuart_clock(imx_startup_data_t * startup_data)
{
    sc_err_t           sc_status;
    sc_pm_clock_rate_t rate;
 ...
 * @return Execution status.
 */
int imx_init_pcie_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
 ...
 * @return Execution status.
 */
int imx_init_gpu_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
 ...
 * @return Execution status.
 */
int imx_init_isi_csi_clock(imx_startup_data_t * startup_data)
{
    sc_err_t sc_status;
    sc_pm_clock_rate_t rate;
    sc_rsrc_t i;
 ...
 * @return Execution status.
 */
int imx_init_dma_clock(imx_startup_data_t * startup_data)
{
    uint32_t  i;
    sc_err_t  sc_status;
    sc_rsrc_t pm_en[] = {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx8xp/imx_init_clocks.c $ $Rev: 904305 $")
#endif
