...
/* Additional setup for certain generic peripherals */
    ...
    extern void imx_usb2_otg1_host_init(void);
    extern void imx_usb3_otg2_host_init(void);
#endif
 ...
 * @return    Always 0.
 */
int imx_init_pca9557(imx_startup_data_t * startup_data)
{
    uint8_t data[2];
 ...
 * @return    Always 0.
 */
int imx_init_pca6416(imx_startup_data_t * startup_data)
{
    uint8_t data[3];
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx8xp/qxp-cpu/main.c $ $Rev: 904589 $")
#endif
