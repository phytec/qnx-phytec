 ...
 */
int imx_add_common_device(const char *device_name, paddr_t base, uint32_t size, uint32_t *irq, uint32_t irq_count,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx8xp/qxp-cpu/init_hwinfo.c $ $Rev: 887163 $")
#endif
