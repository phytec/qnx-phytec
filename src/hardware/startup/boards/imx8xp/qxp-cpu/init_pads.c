 ...
 * @return Execution status.
 */
static int imx_init_lpspi_pads(imx_startup_data_t * startup_data)
{
    imx_pad_t pads[] = {
        /* SPI0 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/boards/imx8xp/qxp-cpu/init_pads.c $ $Rev: 891625 $")
#endif
