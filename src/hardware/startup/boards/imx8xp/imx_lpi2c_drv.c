 ...
 */
void imx_lpi2c_clear_flags(imx_base_t base)
{
 ...
 * @param base LPI2C base address.
 */
void imx_lpi2c_reset(imx_base_t base)
{
 ...
 */
int imx_lpi2c_wait_busy(imx_base_t base)
{
    /* Wait for 5000 us */
    int timeout = 5000;
 ...
 * @return Execution status.
 */
int imx_lpi2c_send_byte(imx_base_t base, uint8_t data, imx_i2c_cmd_t cmd)
{
 ...
 * @return Execution status.
 */
int imx_lpi2c_send_addr(imx_base_t base, unsigned addr, imx_lpi2c_addr_fmt_t fmt,  int read)
{
    int status;
...
int imx_lpi2c_stop(imx_base_t base)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx8xp/imx_lpi2c_drv.c $ $Rev: 850159 $")
#endif
