 ...
 */
i2c_status_t imx_send_int(void *hdl, void *buf, unsigned int len, unsigned int stop)
{
    imx_dev_t *dev = hdl;
 ...
 * @retval I2C_STATUS_NACK  Slave no-acknowledge.
 */
i2c_status_t imx_send_noint(void *hdl, void *buf, unsigned int len, unsigned int stop)
{
    imx_dev_t *dev = hdl;
    i2c_status_t status;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/i2c/imx8/send.c $ $Rev: 870816 $")
#endif
