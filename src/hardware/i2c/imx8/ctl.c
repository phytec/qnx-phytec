 ...
 */
int imx_ctl(void *hdl, int cmd, void *msg, __attribute__((unused)) int msglen,
                __attribute__((unused)) int *nbytes, __attribute__((unused)) int *info)
{
    imx_dev_t *dev = hdl;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/i2c/imx8/ctl.c $ $Rev: 893360 $")
#endif
