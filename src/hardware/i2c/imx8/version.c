 ...
 *
 * @param version Pointer to i2c_libversion_t structure to fill.
 *
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/i2c/imx8/version.c $ $Rev: 869802 $")
#endif
