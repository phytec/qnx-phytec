 ...
 * @retval 0 Not found.
 */
int query_hwi_device(imx_dev_t *dev, unsigned unit)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/i2c/imx8/options.c $ $Rev: 869802 $")
#endif
