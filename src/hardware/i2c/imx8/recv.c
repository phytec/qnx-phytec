 ...
 */
static i2c_status_t imx_recv_int(void *hdl, void *buf, unsigned int len, unsigned int stop)
{
    imx_dev_t *dev = hdl;
 ...
 * @retval I2C_STATUS_NACK  Slave no-acknowledge.
 */
static i2c_status_t imx_recv_noint(void *hdl, void *buf, unsigned int len, unsigned int stop)
{
    imx_dev_t *dev = hdl;
    i2c_status_t status;
    uint16_t rd;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/i2c/imx8/recv.c $ $Rev: 893360 $")
#endif
