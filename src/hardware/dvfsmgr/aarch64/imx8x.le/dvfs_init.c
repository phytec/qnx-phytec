...
extern int init_cpu_info(dvfs_t *dev);
extern void cpu_info_fini(dvfs_t *dev);
extern int dvfs_create_thread_cpu_act(cpustate_t *cpustate);
extern int get_cpu_pwr_levels_count();
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/dvfsmgr/aarch64/imx8x.le/dvfs_init.c $ $Rev: 847526 $")
#endif
