...
#ifndef DVFS_PRIV_API_H
#define DVFS_PRIV_API_H
...
/**
 * pre_pwr_lvl_config: Perform pre-processing before power level change
 * - Description: This function is an optional call for platforms that require
 * any pre-action before power levels are changed.
 * - Arguments:
 *  - handle: A pointer to the global dvfs structure
...
#endif /* DVFS_PRIV_API_H */


#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/dvfsmgr/dvfs_priv_api.h $ $Rev: 774853 $")
#endif
