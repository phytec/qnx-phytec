...
int dvfs_dvfs_table_init(dvfs_t *handle);
...
int get_cpu_pwr_levels_count(void);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/dvfsmgr/dvfs.h $ $Rev: 894097 $")
#endif
