...
static int imx_bs_args(sdio_hc_t *hc, char *options)
{
    ...
    ext->rs_pin = 0;
    ext->driver_type = 0;
    ext->sdll = IMX_USDHC_STROBE_DLL_CTRL_SLV_DLY_TARGET_DEFAULT_VALUE;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/sdmmc/aarch64/mx8x.le/bs.c $ $Rev: 911790 $")
#endif
