...
static int imx_sdhcx_std_tune(sdio_hc_t *hc, int op)
{
    ...
    if (status || (acmd12 & IMX_USDHC_AUTOCMD12_ERR_STATUS_EXECUTE_TUNING_MASK)) {
...
int imx_sdhcx_init(sdio_hc_t *hc)
{
    ...
    if ((hwi_off != HWI_NULL_OFF) && (mcu == IMX_CHIP_TYPE_QUAD_MAX) && (mcu_rev == IMX_CHIP_REV_A)) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/sdmmc/sdiodi/hc/imx8_hc.c $ $Rev: 911790 $")
#endif
