...
static int sdhci_adma_setup( sdio_hc_t *hc, sdio_cmd_t *cmd )
{
	...
	sdhci_out32( sdhc->base + SDHCI_ADMA_ADDRL, (uint32_t)sdhc->admap );
	if( ( sdhc->flags & SF_USE_ADMA64 ) ) {
		sdhci_out32( sdhc->base + SDHCI_ADMA_ADDRH, sdhc->admap >> 32);
	}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/sdmmc/sdiodi/hc/sdhci.c $ $Rev: 895345 $")
#endif
